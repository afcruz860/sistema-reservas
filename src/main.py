...
# Función para crear un cliente a partir de los datos ingresados en la interfaz.
# Valida la información y muestra mensajes de éxito o error.
...
# Función para crear un servicio según el tipo seleccionado en el combo.
# Aplica validaciones y muestra mensajes de confirmación.
...
# Función para crear una reserva combinando cliente y servicio.
# Inserta la reserva en la tabla resumen para visualizarla.
...
# Función para cancelar una reserva seleccionada en la tabla.
# Actualiza el estado y refleja el cambio en la interfaz.
...
# Función para procesar una reserva seleccionada en la tabla.
# Aplica impuestos y descuentos, mostrando el resultado.
...
# Se definen etiquetas, entradas de texto, botones y la tabla resumen.
